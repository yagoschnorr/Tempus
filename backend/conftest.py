...
# ---------------------------------------------------------------------------
# Variáveis de ambiente obrigatórias para o Settings do Pydantic.
# Definidas antes de qualquer importação da app para que os testes funcionem
# sem um arquivo .env presente. Os valores são dummies — o banco real nunca é
# acessado (SQLite em memória) e a OpenAI real nunca é chamada (FakeOpenAI).
# ---------------------------------------------------------------------------
import os
